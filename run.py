...
if __name__=='__main__':
    ...
    pybullet.loadURDF(urdf_path+"/plane_with_restitution.urdf", [0, 0, -1], useFixedBase=True)
    ...
    maxIters=1000
    targetPosXId =pybullet.addUserDebugParameter("targetPosX",-5,5,0.2)
    targetPosYId = pybullet.addUserDebugParameter("targetPosY",-5,5,0)
    targetPosZId = pybullet.addUserDebugParameter("targetPosZ",-5,5,-0.1)
    Roll = pybullet.addUserDebugParameter("Roll",-5,5,-0.1)
    Pitch = pybullet.addUserDebugParameter("Pitch",-5,5,1)
    Yaw = pybullet.addUserDebugParameter("Yaw",-5,5,-0.1)
