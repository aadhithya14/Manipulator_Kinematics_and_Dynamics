...
if __name__=='__main__':
    ...
    targetVelXId = pybullet.addUserDebugParameter("targetVelX",-0.2,0.2,0.05)
    targetVelYId = pybullet.addUserDebugParameter("targetVelY",-0.5,0.5,0.05)
    targetVelZId = pybullet.addUserDebugParameter("targetVelZ",0,0.2,0.05)
    Angular_vel_x = pybullet.addUserDebugParameter("targetAngularvelx",-3.14,3.14,0.1)
